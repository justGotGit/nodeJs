...
jsPsych.plugins.instructions = (function() {
  ...
  var plugin = {};
	//jsPsych.pluginAPI.registerPreload('pages','image', function(t){ return !t.is_html || t.is_html == 'undefined'}); //added by Manon to see if it will make images show up faster
  plugin.info = {
    name: 'instructions',
    description: '',
    parameters: {
