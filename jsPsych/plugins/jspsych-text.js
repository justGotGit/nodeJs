...
jsPsych.plugins.text = (function() {
  ...
  //jsPsych.pluginAPI.registerPreload('text', 'image', function(t){ return !t.is_html || t.is_html == 'undefined'}); //added by Manon to see if it will make images show up faster
